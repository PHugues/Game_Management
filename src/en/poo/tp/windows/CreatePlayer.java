...
public class CreatePlayer extends JDialog {
	...
	private static final long serialVersionUID = 2046004465283131345L;
			...
			public void actionPerformed(ActionEvent arg0)
			{
				if(id.getText().length() > 0 && name.getText().length() > 0)
				{
					try
					{
						...
						{
							PrimaryWindow.getServ().getListPlayers().add(new Player(Integer.parseInt(id.getText()), name.getText()));
							dispose();
						}
						else
						{
